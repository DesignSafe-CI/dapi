...
try:
 ...
 print("Liquefaction Susceptibility by Geology:")
...
try:
 ...
 print("Insufficient CPT data for statistical analysis")
...
try:
 ...
 print(f"Distance analysis query failed (likely due to missing coordinates): {e}")
...
try:
 ...
 print(f"\n Depth-Dependent Liquefaction Analysis:")
 ...
 print(f"Depth analysis query failed: {e}")
```
